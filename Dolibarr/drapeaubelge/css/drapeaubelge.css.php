...
/**
 * \file    drapeaubelge/css/drapeaubelge.css.php
 * \ingroup drapeaubelge
 * \brief   CSS file for module Drapeaubelge.
 */
...
.black {
    ...
    width: 33.33%; /* Largeur de la bande noire */
    height: 100%;
...
.yellow {
    ...
    width: 33.33%; /* Largeur de la bande jaune */
    height: 100%;
    float: left; /* Aligner à gauche */
}
...
.red {
    ...
    width: 33.33%; /* Largeur de la bande rouge */
    height: 100%;
    float: left; /* Aligner à gauche */
}

.fa-flag-be {
    background-image: url('/img/object_drapeaubelge.png');
