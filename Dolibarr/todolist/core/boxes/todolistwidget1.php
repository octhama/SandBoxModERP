...
/**
 * \file    todolist/core/boxes/todolistwidget1.php
 * \ingroup todolist
 * \brief   Widget provided by Todolist
 *
 ...
 */
class todolistwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "todolistbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "todolist@todolist";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "todolist@todolist"));
		...
		// $this->hidden = !$user->hasRight('todolist', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/todolist/class/todolist.class.php");

		// Populate the head at runtime
		$text = $langs->trans("TodolistBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_todolist@todolist',
